  //$('body').wrapInner('<div id="pageContainer" />');
  ...
  //            'width: '+width+';right: 0px;left: 0px;">'+
  //   '</iframe>'
  // );
  // document.getElementById(iframeId).contentDocument.body.innerHTML =
  //   '<style type="text/css"> html, body { width: ' +
  //   width +
  //   '; width: 100%; z-index: 2147483647; } </style> <p>UNSTYLED HTML!</p>';
